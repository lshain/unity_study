	...
	public static class LuaBinder
	{
		...
		public static void Bind(IntPtr L, string type = null)
		{
			...
			switch (type)
			{
				...
				case "LT_DelegateFactoryWrap" : LT_DelegateFactoryWrap.Register(L); break;
				case "LT_LogManagerWrap" : LT_LogManagerWrap.Register(L); break;
				...
				case "UnityEngine_Rendering_ShadowCastingModeWrap" : UnityEngine_Rendering_ShadowCastingModeWrap.Register(L); break;
