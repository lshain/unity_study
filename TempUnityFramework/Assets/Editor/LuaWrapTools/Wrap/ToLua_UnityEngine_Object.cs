...
namespace LT
{
    ...
    {
        [NoToLuaAttribute] public static string DestroyDefined =
...
";
        ...
        [NoToLuaAttribute] public static string DestroyImmediateDefined =
            @"		int count = LuaDLL.lua_gettop(L);
...
";
        ...
        [NoToLuaAttribute] public static string DestroyObjectDefined =
            @"		int count = LuaDLL.lua_gettop(L);
