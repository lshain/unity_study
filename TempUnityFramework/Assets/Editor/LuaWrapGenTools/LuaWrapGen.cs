...
public static class LuaWrapGen
{
    ...
    private static readonly string LUA_WRAPFILE_DIR = Application.dataPath + "/Script/LuaEngine/Wrap/";
    private static readonly string LUA_BINDER_FILE = Application.dataPath + "/Script/LuaEngine/Base/LuaBinder.cs";
    static LuaWrapGen()
    {
        if (!Directory.Exists(LUA_WRAPFILE_DIR))
        {
            Directory.CreateDirectory(LUA_WRAPFILE_DIR);
        }
    }
    ...
    [MenuItem("LuaEngine/Gen LuaWrap Files", false, 1)]
    ...
    [MenuItem("LuaEngine/Gen LuaBinder Files", false, 3)]
    ...
    [MenuItem("LuaEngine/Clear LuaBinder Files", false, 13)]
